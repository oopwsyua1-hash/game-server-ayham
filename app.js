      ...
      <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .neon-grid {
          ...
          background-image: linear-gradient(cyan 2px, transparent 2px), linear-gradient(90deg, cyan 2px, transparent 2px);
        ...
        .container { position: relative; z-index: 1; padding-top: 10vh; }
        h1 {
          font-size: 4rem; font-weight: 900; color: #fff;
          text-shadow: 0 0 10px #fff, 0 0 20px #ff0080, 0 0 30px #ff0080, 0 0 40px #ff0080;
          animation: heartBeat 1s ease-in-out infinite; margin-bottom: 30px;
        }
        @keyframes heartBeat {
        ...
        .waves { display: flex; justify-content: center; gap: 5px; height: 60px; margin: 20px 0; }
        .bar {
          width: 6px; background: linear-gradient(to top, #ff0080, #00ffff);
        ...
        .status {
          ...
          display: inline-block; padding: 25px 45px; border-radius: 25px;
          border: 3px solid #ff0080;
          box-shadow: 0 0 20px #ff0080, inset 0 0 20px rgba(255,0,128,0.3);
        }
        p { font-size: 1.3rem; margin: 12px 0; font-weight: 700; }
